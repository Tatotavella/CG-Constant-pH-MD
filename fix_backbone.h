...
//  TBV ****fm_table;
  ...
  double temp_montecarlo,D_ele,D_pH,D_self, V_electro;

  int mc_charge_change(int *rsd, double *D_ele, double *D_pH, double *D_self, double *V_electro, double *Nu_pol, double *Nu_nonpol);
  double electro_i_j(int i, int j, double *array);
  double electro_i_j_terminal(int i, int j, double *array);
  double count_pol(int i);
  double count_nonpol(int i);
  ...
  double delta_self(int rnd_idx, int place_change, int new_chrg, double *Nu_pol, double *Nu_nonpol);
  //---------------------FRANCO -----------------------------------------------------------------------------------------------
